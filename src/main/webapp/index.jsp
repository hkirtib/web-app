...
<body>
	...
	<h1 style="color: black; font-size: 40px;" align="center">THIS IS APP DEPLOYMENT USING TOMCAT</h1>
	<h1 style="color: black; font-size: 40px;" align="center">Deploy webapp with new version</h1>
